const BFC = (parameters) => {
    ...
    self.render = (data) => {
        /* Page Title */
        self.page_title = self.svg.append('text')
            .attr('x', self.width / 2)
            .attr('y', 20)
        ...
        self.svg.append('rect')
            .attr('x', self.width / 2 - self.page_width / 2)
            .attr('y', self.page_y)
        ...
        self.svg.selectAll('.line')
            ...
            .enter()
            .append('rect')
            .attr('x', self.width / 2 - self.page_width / 2 + self.page_padd)
            .attr('y', (d, i) => {
            ...
            .attr('width', self.page_width - 2 * self.page_padd)
